...
], Roles.prototype, "dateEntered", void 0);
__decorate([
    typeorm_1.Column("datetime", { name: "date_modified", nullable: true }),
    __metadata("design:type", Date)
], Roles.prototype, "dateModified", void 0);
__decorate([
    typeorm_1.Column("char", { name: "modified_user_id", nullable: true, length: 36 }),
    __metadata("design:type", String)
], Roles.prototype, "modifiedUserId", void 0);
__decorate([
...
__decorate([
    typeorm_1.Column("text", { name: "modules", nullable: true }),
    __metadata("design:type", String)
], Roles.prototype, "modules", void 0);
__decorate([
    typeorm_1.Column("tinyint", { name: "deleted", nullable: true, width: 1 }),
    __metadata("design:type", Boolean)
], Roles.prototype, "deleted", void 0);
Roles = __decorate([
    typeorm_1.Index("idx_role_id_del", ["id", "deleted"], {}),
    typeorm_1.Entity("roles", { schema: "sugar" })
], Roles);
exports.Roles = Roles;
